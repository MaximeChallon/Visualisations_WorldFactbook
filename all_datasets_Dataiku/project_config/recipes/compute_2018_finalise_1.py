...
# Read recipe inputs
in_pays = dataiku.Dataset("2004_pays_prets")
...
for row in in_pays.iter_rows():
    dico_soldats_pays_orgs[row["name"]]=row["Soldats_2004"]
...
for row in in_pays.iter_rows():
    dico_morts_pays_orgs[row["name"]]=row["MortsGuerre_2004"]
...
for row in in_pays.iter_rows():
    dico_depensesMil_pays_orgs[row["name"]]=row["DepensesMilitairesPIB_2004"]
...
for row in in_pays.iter_rows():
    dico_export_pays_orgs[row["name"]]=row["Exportations_2004"]
...
for row in in_pays.iter_rows():
    dico_import_pays_orgs[row["name"]]=row["Importations_2004"]
...
out = dataiku.Dataset("2004_finalise")
